...
public class ImageScaleTest {
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            try {
                original = ImageIO.read(new File("E:\\IMAGES\\WP_20140420_047.jpg"));
                //scaled = original.getScaledInstance(original.getWidth() / 2, original.getHeight() / 2, Image.SCALE_DEFAULT);
                scaled = original.getScaledInstance(10, 10, Image.SCALE_DEFAULT);
    ...
    public static BufferedImage getScaledInstance(BufferedImage img, double dScaleFactor, RenderQuality quality) throws IOException {
...
//            System.out.println("Scale low quality...");
    ...
    protected static BufferedImage getScaledInstance(BufferedImage img, double dScaleFactor, Object hint, boolean bHighQuality) throws IOException {
        ...
        ImageIO.write(imgScale, "jpg", new File("C:\\Users\\akhtar\\Desktop\\New.jpg"));
        return imgScale;
