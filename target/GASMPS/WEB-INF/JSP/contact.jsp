                            ...
                            <form id="contactForm">
                                <div class="col-md-6 contact-bottom">
                                    <div class=" in-contact">
                                        <input  type="text" name="contactName" placeholder="Name" required="" maxlength="100">
                                    </div>
                                    <div class=" in-contact">
                                        <input type="text" name="contactEmail"  placeholder="Email" required="" maxlength="100">
                                    </div>
                                    <div class=" in-contact">
                                        <input type="text" name="contactMobile" placeholder="Mobile Number" required="" maxlength="10">
                                    </div>

                                </div>

                                <div class="col-md-6 contact-bottom-top">
                                    <textarea name="contactMessage" placeholder="Message"  required="" maxlength="1500"></textarea>								
                                </div>
                                <div class="clearfix"> </div>
                                <div class="send-top">
                                    <label class="hvr-rectangle-out">
                                        <input type="button" id="contactSubmit" value="Send" >
                                    </label>
                                </div>
                            </form>
